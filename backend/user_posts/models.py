...
class UserPostModels(models.Model):
    ...
    post_img=models.ImageField(upload_to="posts/post_img", default="posts/post_img/post.jpg")
    post_video=models.ImageField(upload_to="posts/post_vedio", default="posts/post_vedio/post.mp4")
